 ...
 *
 */
public class BcyPicturesWaterFallLoadMoreAdapter extends RecyclerView.Adapter<BcyPicturesWaterFallLoadMoreAdapter.ViewHolder> {
    ...
    public BcyPicturesWaterFallLoadMoreAdapter(Context context, LoadMoreListener loadMoreListener){
        this.mContext = context;
        this.loadmorelistener = loadMoreListener;
    }

    public void getRandomHeight(List<PictureInfo> mList){
        if (mHeights == null) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        PictureInfo bean = mList.get(position);
        ImageLoader.getInstance().displayImage(bean.getPictureUrl(),
